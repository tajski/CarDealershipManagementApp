...
namespace FMS.FMSDataSetTableAdapters {
    ...
    public partial class statusesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[statuses] WHERE (([status_id] = @Original_status_id) AND ([sta" +
                "tus_name] = @Original_status_name))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[statuses] SET [status_name] = @status_name WHERE (([status_id] = @O" +
                "riginal_status_id) AND ([status_name] = @Original_status_name));\r\nSELECT status_" +
                "id, status_name FROM statuses WHERE (status_id = @status_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FMS.Properties.Settings.Default.connectionString;
        }
        ...
        public virtual int Fill(FMSDataSet.statusesDataTable dataTable) {
        ...
        public virtual FMSDataSet.statusesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            FMSDataSet.statusesDataTable dataTable = new FMSDataSet.statusesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(FMSDataSet.statusesDataTable dataTable) {
